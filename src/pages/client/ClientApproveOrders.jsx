        ...
        <div className="p-6 space-y-5">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-gray-600 leading-relaxed">
              Indica el motivo del rechazo. Quedara registrado en el historial
              del pedido.
            </p>
            {order && (
            ...
            <table className="w-full text-sm">
                  ...
                  <tr key={idx}>
                    <td className="px-4 py-3">
                      ...
                      <p className="text-xs text-gray-400">
                        {formatCOP(item.unitPrice)} / {item.unit}
                      </p>
                    </td>
              ...
              <tfoot>
                <tr className="bg-gray-50 border-t border-gray-100">
                  <td
                    colSpan={2}
                    className="px-4 py-3 text-sm font-semibold text-gray-600 text-right"
                  >
                    Total
                  </td>
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-xl px-5 py-4 text-sm text-yellow-800">
        Los pedidos aprobados quedan disponibles para que el asesor comercial
        los gestione. Los rechazados no pasan a gestión.
      </div>
