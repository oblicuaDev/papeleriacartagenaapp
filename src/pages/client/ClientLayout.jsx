...
export default function ClientLayout() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <Link
        to="/manual"
        title="Manual de usuario — Cómo realizar un pedido"
        className="fixed bottom-6 right-5 z-30 flex items-center gap-2 bg-blue-700 hover:bg-blue-800 text-white rounded-full shadow-lg px-4 py-2.5 text-xs font-semibold transition group"
      >
